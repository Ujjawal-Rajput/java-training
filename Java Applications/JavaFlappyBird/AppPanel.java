...
public class AppPanel extends JPanel {
    ...
    public AppPanel(AppFrame fb, Bird bird, ArrayList<Rectangle> rects) {
        this.fb = fb;
        this.bird = bird;
        this.rects = rects;
    ...
    public void paintComponent(Graphics g) {
        g.setColor(bg);
        g.fillRect(0,0,AppFrame.WIDTH,AppFrame.HEIGHT);
        bird.update(g);
        ...
        for(Rectangle r : rects) {
            ...
            if(r.y < AppFrame.HEIGHT/2) {
                g2d.translate(0, r.height);
                g2d.rotate(Math.PI);
            }
            g2d.drawImage(pipeHead, -PIPE_W/2, -PIPE_H/2, AppPanel.PIPE_W, AppPanel.PIPE_H, null);
            g2d.drawImage(pipeLength, -PIPE_W/2, PIPE_H/2, AppPanel.PIPE_W, r.height, null);
        ...
        if(fb.paused()) {
            ...
            g.drawString("PAUSED", AppFrame.WIDTH/2-100, AppFrame.HEIGHT/2-100);
            // g.drawString("PRESS SPACE TO BEGIN", AppFrame.WIDTH/2-300, AppFrame.HEIGHT/2+50);
        }
    }
}